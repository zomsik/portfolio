    ...
    resources: {
      ...
      pl: {
        translation: {
         ...
         descTower: "Gra typu Tower Defense wykorzystująca mechanizm generowania proceduralnego. Gra została napisana w Javie na szkielecie programistycznym LibGDX. Na podstawie losowego ziarna tworzona jest mapa, fale przeciwników, nagrody za ich pokonanie i tym podobne. Gra zawiera zaawansowany system ulepszeń pasywnych przechodzący pomiędzy kolejnymi rozgrywkami na tym samym profilu. Istnieje możliwość zapisu zarówno lokalnie, jak i w chmurze. Serwer wykorzystuje hosting na platformie Microsoft Azure.",
